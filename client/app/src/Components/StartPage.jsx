...
export default function StartPage() {
  ...
  return (
    <>
      ...
      <div className="inlineBox">
        ...
        <div className="SecondBox">
          ...
          <div className="optionsGame">
            <p>
              Gra Mole Escape polega na sterowaniu krecikiem klawiszami: w -
              góra, a - lewo, s - dół, d - prawo.{" "}
            </p>
            <p>
              Trzeba zbierać owoce które dają 1 punkt, donaty które dają 5
              punktów,{" "}
            </p>
            <p>Natomiast gdy krecik zje kupe to straci 3 punkty.</p>
            <p>
              Żeby nie przegrać trzeba omijać starą babcię oraz gniewnego
              młodego rolinka.
            </p>
            <p>
              W grze naliczają się punkty zdobyte punkty oraz odlicza się czas
              rozgrywki.
            </p>
          </div>
        </div>
        ...
        <div className="ThirdBox">
          ...
          <ul>
            {topPlayers.map((player, index) => (
              <li key={index}>
                {index + 1}. {player.Nick} - Wynik: {player.Score}
              </li>
            ))}
          </ul>
        </div>
      ...
      {isOpen && <Popup handleClose={togglePopup} nick={nick} />}
    </>
  );
}
